...
datasets:
	source venv/bin/activate && convert bundle/analyze/datasets/tap-example/ rawdata/ bundle/analyze/datasets/tap-example/output || convert bundle/analyze/datasets/tap-example/ rawdata/ bundle/analyze/datasets/tap-example/output
